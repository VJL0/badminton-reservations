    ...
    <main className="mx-auto flex w-full max-w-3xl flex-col gap-6 px-4 py-6 lg:gap-8 lg:px-8 lg:py-10">
        ...
        <CardContent className="flex flex-col gap-4">
          ...
          {flagged.length > 0 ? (
            <div className="flex flex-col gap-2">
              <h3 className="font-display text-xl font-extrabold uppercase tracking-[0.04em]">Needs attention</h3>
              <ul className="flex flex-col gap-2">{flagged.slice(0, 3).map(flagCard)}</ul>
              {flagged.length > 3 && (
                <details className="group">
                  <summary className="min-h-11 cursor-pointer list-none py-2 text-sm font-semibold underline underline-offset-4 outline-none focus-visible:ring-2 focus-visible:ring-mat [&::-webkit-details-marker]:hidden">
      ...
      <Card>
        ...
        <CardContent>
          ...
          {older.length > 0 && (
            <details className="group">
              <summary className="min-h-11 cursor-pointer list-none py-3 text-sm font-semibold underline underline-offset-4 outline-none focus-visible:ring-2 focus-visible:ring-mat [&::-webkit-details-marker]:hidden">
